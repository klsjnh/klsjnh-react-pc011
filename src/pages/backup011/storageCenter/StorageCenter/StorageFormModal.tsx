  ...
  return (
    ...
    >
      <Form form={form} layout="vertical" style={{ marginTop: 16 }}>
        ...
        {provider === 'local011' && (
          <Form.Item name="basePath" label="本地根路径（local011 必填）">
            <Input placeholder="D:/Klsjnh/upload" />
          </Form.Item>
        )}
        {provider !== 'local011' && (
          <Form.Item name="endpoint" label="Endpoint（S3 系必填）">
        ...
        <Form.Item name="secure" label="是否 HTTPS" valuePropName="checked">
          <Switch />
        </Form.Item>
