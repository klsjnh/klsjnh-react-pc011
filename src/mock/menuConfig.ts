...
const initialMenuConfig: MenuConfig[] = [
  {
    ...
    children: [
      { id: 101, parentId: 1, name: 'Menu', path: '/system011/julyMenu', icon: '📋', title: '菜单管理', type: 'page', sort: 1, visible: true },
      { id: 104, parentId: 1, name: 'Organization', path: '/system011/julyOrganization', icon: '🏢', title: '组织管理', type: 'page', sort: 2, visible: true },
      { id: 105, parentId: 1, name: 'User', path: '/system011/julyUser', icon: '👥', title: '用户管理', type: 'page', sort: 3, visible: true },
      { id: 102, parentId: 1, name: 'Permission', path: '/system011/julyPermission', icon: '🔑', title: '权限管理', type: 'page', sort: 4, visible: true },
    ],
  },
  {
